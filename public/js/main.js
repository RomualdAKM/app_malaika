...
if (datasTable2.find("tbody tr").length > 0) {
    ...
    const dataTableInstance2 = datasTable2
        .DataTable({
            ...
            dom: 't<"flex justify-between p-4 text-xs font-semibold tracking-wide text-gray-500 uppercase border-t bg-gray-50" <"flex items-center col-span-3" B><"col-span-2"> <"flex col-span-4 mt-2 sm:mt-auto sm:justify-end"p>><"clear">',
            language: {
                decimal: "",
